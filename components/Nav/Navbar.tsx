    ...
    <div className="w-full h-20 border-b-[1px] lg:h-20 border-gray-500 text-black lg:text-green-400">
      <div className="max-w-screen-2xl h-full mx-auto px-4 flex items-center justify-between">
        ...
        <ul className="hidden lg:inline-flex items-center gap-8 uppercase text-sm font-semibold">
          <li className="navbarLi">Đặt phòng</li>
          <li className="navbarLi">Thuê xe</li>
          <li className="navbarLi">Dịch vụ</li>
          <li className="navbarLi">Địa điểm tham quan</li>
          <li className="navbarLi">Quy tắc chung</li>
        </ul>
